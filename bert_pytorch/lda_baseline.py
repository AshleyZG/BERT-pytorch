...
graphs = []
with open('/homes/gws/gezhang/jupyter-notebook-analysis/graphs/cell_with_func_python23_1_27.txt', 'r') as f:
    for l in tqdm(f):
        graphs.append(json.loads(l))

split_point = int(len(graphs) * 0.8)
lda_results = numpy.load(
    '/homes/gws/gezhang/jupyter-notebook-analysis/lda_results_1_30_2.npy', allow_pickle=True)
...
test_lda_results = numpy.load(
    '/homes/gws/gezhang/jupyter-notebook-analysis/test_lda_results_1_30_2.npy', allow_pickle=True)
